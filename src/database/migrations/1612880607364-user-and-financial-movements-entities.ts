...
export class userAndFinancialMovementsEntities1612880607364
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "financial_movements" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "name" character varying NOT NULL, "value" double precision NOT NULL, "classification" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, "updated_at" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP, CONSTRAINT "PK_025cc87a04960e08a8a9db1833d" PRIMARY KEY ("id"))`,
        );
        await queryRunner.query(
            `ALTER TABLE "financial_movements" ADD CONSTRAINT "FK_21509fc9358ea587bd623462033" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
        );
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(
            `ALTER TABLE "financial_movements" DROP CONSTRAINT "FK_21509fc9358ea587bd623462033"`,
        );
